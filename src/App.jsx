...
//   return (
//     <div
//       className="m-0  break-keep bg-white text-black accent-carrot"
//       lang="ko"
//     >
//       <div className="block outline-none">
//         <header className="fixed h-[68px] top-0 bg-white md:w-full delay-300 m-0 block">
//           <div className="box-border max-w-75 m-auto px-6 flex flex-row justify-between items-center h-full">
//             <a
//               href="/"
...
//                   className="block absolute top-1/2 right-0 translate-y-1/2 z-2 cursor-pointer leading-full m-0"
//                 >
//                   <svg
//                     viewBox="0 0 100 100"
...
//                 </label>
//               </div>
//               <ul className="flex flex-row items-center gap-14 relative p-0 m-0 font-bold">
//                 <li className="">
//                   <a href="#">팀문화</a>
//                 </li>
//                 <li className="">
...
//           <h1 className=" font-black text-[52px] mb-20 whitespace-pre-line">
//             {`이웃과 더 가까워지는
//             따뜻한 동네를 만들어요.`}
//           </h1>
    ...
    <div>
      <div>
        <div className="relative">
          <header className="w-screen h-68px bg-white m-0 sticky top-0">
